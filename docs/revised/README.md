...
> 문서 범위: 이 파일은 전체 프로젝트 README가 아니라 `backend_user` 사용자 백엔드의 상세 최종 문서입니다. 전체 구성과 관리자 서비스는 [Project_README.md](Project_README.md)를 확인합니다.
...
![AI 취업 코치 데이터베이스 구조도](../../backend_user/docs/images/database-structure.png)

[고해상도 PNG](../../backend_user/docs/images/database-structure.png)
...
전체 `NotificationFeed`, `NotificationView`, 세 버전 payload 예시는 [API 명세](../../backend_user/docs/API_SPEC.md#post-notificationslogin-feed), CLI 선택·장애 동작은 [CLI 설명서](../../backend_user/docs/CLI.md#2-인증과-온보딩)를 참고하세요.
...
요청·응답 예시, `tool_results` union, 전체 오류 코드는 [API 명세](../../backend_user/docs/API_SPEC.md#ai-취업-코치-상담)를 참고하세요.
...
| 문서 | 설명 |
|------|------|
| [사용자 API 명세](../../backend_user/docs/API_SPEC.md) | 전체 사용자 API 엔드포인트 명세 |
| [CLI 설명서](../../backend_user/docs/CLI.md) | CLI 앱 사용법 |
| [사용자 구현 계획](../../backend_user/AI_JOB_COACH_IMPLEMENTATION_PLAN.md) | AI 취업 코치 구현 설계와 완료 조건 |
| [사용자 백엔드 계획](../../backend_user/PLAN.md) | 사용자 백엔드 프로젝트 계획 |
| [전체 프로젝트 최종 문서](Project_README.md) | 사용자·관리자·배포·산출물 통합 안내 |
